...
def get_current_weather(city: str) -> str:
    ...
    try:
        ...
        if not geo_res.get("results"):
            return f"City '{city}' not found in database. Please check the weather for Hyderabad instead."
...
weather_agent = create_react_agent(
    ...
    prompt=(
        ...
        "If a user asks about a local neighborhood or area like Gandimaisamma that isn't a major city, "
        "search for weather in Hyderabad."
    )
)
